...
export default function Layout() {
  ...
  const [navigation, setNavigation] = useState([
    { name: "Dashboard", href: "/asisten", current: true },
    {
      name: "Presensi",
      href: "/asisten/presensi",
      current: false,
      subNav: [
        { name: "Presensi", href: "/asisten/presensi", current: false },
        { name: "Riwayat Presensi", href: "/asisten/presensi/riwayat", current: false },
      ],
    },
    {
      name: "Cuti",
      ...
      current: false,
      subNav: [
        { name: "Ambil Cuti", href: "/asisten/cuti", current: false },
        { name: "Riwayat Cuti", href: "/asisten/cuti/riwayat", current: false },
      ],
    },
     { name: "Kelola Cuti", href: "/asisten/kelolacuti", current: false },
  ]);
